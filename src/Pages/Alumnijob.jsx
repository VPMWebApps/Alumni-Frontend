...
function Alumnijob() {
  ...
  const jobs = [
    {
      ...
      Company: "WalletX",
      date: "3 Days ago",
      alumni:"Posted by Jane Doe '$2015 • Software Engineering",
      description:
        "Seeking a talented engineer to join our growing team. Experience with React and Node.js required.",
      btn: "Apply Now",
    },
    {
      ...
      date: "5 Days ago",
      alumni:"Posted by John Smith '$2018 • Marketing",
      description:
        "We are looking for a creative marketing professional to drive our product strategy.",
      btn: "Apply Now",
    },
  ];
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto mt-20 mb-12 px-10">
      ...
      <div className="container mx-auto mt-10">
        <form className="flex items-center max-w-lg mx-auto">
          ...
          <button
            type="button" // Changed to button type "button"
      ...
      {isOpen && (
        <form className="space-y-4 mt-4 p-4 border rounded-lg shadow-md">
          ...
          <div>
            <label className="font-medium text-sm mb-5 block">Loaction</label>
            <input
                type="text"
    ...
    {filteredJobs.length > 0 ? (
        filteredJobs.map((job, index) => (
          ...
          >
            ...
            <div className="px-4 flex flex-col md:flex-row md:justify-between mt-4">
              ...
              <button className="mt-4 bg-blue-800 text-white py-2 px-4 w-full md:w-56 rounded-lg hover:bg-blue-700 ">
                Apply Now
              </button>
              </div>
            {/* Alumni Member */}
        ...
        <p className="text-center text-4xl font-semibold text-gray-500">No jobs found :(</p>
      )}
    </>
  );
}
