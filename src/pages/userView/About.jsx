  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: NAVY3, fontSize: "0.65em" }}>{suffix}</span>
      </div>
      <div
        style={{
    ...
    >
      ...
      <div
        style={{
          ...
          height: 300,
          borderRadius: "50%",
          background: "rgba(47,90,199,0.14)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          height: 220,
          borderRadius: "50%",
          background: "rgba(47,90,199,0.08)",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        style={{
          ...
          height: 3,
          background:
            "linear-gradient(90deg, transparent 0%, #3b82f6 30%, #93c5fd 55%, transparent 100%)",
        }}
      />
...
const timelineItems = [
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/256395/pexels-photo-256395.jpeg?auto=compress&cs=tinysrgb&w=900",
    accent: "#1a6b5a",
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/267885/pexels-photo-267885.jpeg?auto=compress&cs=tinysrgb&w=900",
    accent: "#6c4fa0",
    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow: inView
            ? `0 0 0 4px ${item.accentAlpha}0.15), 0 0 16px ${item.accentAlpha}0.25)`
            : "none",
      ...
      >
        ...
        <div
          style={{
            ...
            gap: 6,
            background: `${item.accentAlpha}0.08)`,
            border: `1px solid ${item.accentAlpha}0.2)`,
            borderRadius: 100,
            padding: "4px 12px",
            marginBottom: 10,
          }}
    ...
    >
      ...
      <section
        style={{
          ...
          padding: isMobile ? "20px 10px" : "52px 0",
          position: "relative",
        }}
      >
        {/* Top Gradient Line */}
        <div
          style={{
            ...
            right: 40,
            height: 2,
            background: `linear-gradient(90deg, transparent, ${NAVY2} 30%, ${NAVY3} 70%, transparent)`,
          }}
        />
        ...
        >
          {[
            ...
            <div
              ...
              style={{
                borderRight:
                  !isMobile && i < 2 ? `1px solid ${BORDER}` : "none",
                padding: isMobile ? "8px 4px" : "0 16px",
                textAlign: "center",
              }}
            >
              <CounterStat {...s} isMobile={isMobile} />
            </div>
          ))}
        </div>
      </section>
      ...
      <section
        style={{
          padding: isMobile ? "48px 20px 28px" : "72px 40px 52px",
          textAlign: "center",
        }}
      >
        <div
      ...
      <section
        style={{
          maxWidth: 1100,
          margin: "0 auto",
          padding: isMobile ? "0 18px 64px" : "0 40px 96px",
        }}
      >
